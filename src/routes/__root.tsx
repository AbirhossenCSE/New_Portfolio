...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Abir Hossen — Full-Stack Developer" },
      {
        name: "description",
        content:
          "Abir Hossen is a full-stack developer specializing in React, Node.js, Express, and MongoDB — building modern, scalable, performance-driven web applications.",
      },
      { name: "author", content: "Abir Hossen" },
      { property: "og:title", content: "Abir Hossen — Full-Stack Developer" },
      {
        property: "og:description",
        content:
          "Modern, scalable web applications built with React, Node.js, Express and MongoDB. Available for full-time & freelance work.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Abir Hossen — Full-Stack Developer" },
